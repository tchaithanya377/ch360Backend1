#!/usr/bin/env python3
"""
Comprehensive test script for the enhanced Assignment Management System with Authentication
Tests all API endpoints with proper authentication and various test cases
"""
...
class AssignmentTester:
    ...
    def authenticate(self):
        ...
        try:
            # Try to get admin user credentials
            auth_data = {
                "email": "komalkumarn@mits.ac.in",
                "password": "admin123"  # Default password, might need adjustment
            }
            ...
            # If login fails, try different credentials
            ...
            if response.status_code == 200:
                ...
                if assignments:
                    ...
                    if response.status_code == 200:
                        ...
                        outcome_data = {
                            "outcome": "Students will understand machine learning concepts",
    ...
    def run_all_tests(self):
        """Run all tests"""
        print("🚀 Starting Comprehensive Assignment Management System Tests with Authentication")
        print("=" * 80)
    ...
    def generate_test_report(self):
        ...
        report_file = f"assignment_auth_test_report_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
